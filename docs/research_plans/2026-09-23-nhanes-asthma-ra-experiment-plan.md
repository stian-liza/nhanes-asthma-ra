...
版本：0.3，2026-09-23。状态：**用户已整体确认v0.2并确认范围修订A；实施已授权。计划确认不代表数据或结论已验证。**

版本变更：官方逐周期审核发现1999–2000成人当前哮喘未询问，用户确认[范围修订A](2026-09-23-scope-amendment.md)。主分析改为2001–2018当前哮喘，1999–2018曾患哮喘为补充；v0.2由Git历史保留。以下其余方法不变。
...
**在 NHANES 2001–2018 的 20 岁及以上美国非机构化平民成人中，自报医生诊断的 RA 者是否更常报告当前哮喘？考虑年龄、性别、吸烟及社会经济差异后，这一患病关联的大小和不确定性如何？**

RA 是 rheumatoid arthritis（类风湿关节炎）。本研究的 RA 实际指“自报曾被医生告知有关节炎，且报告类型为 RA”。当前哮喘指“曾被医生告知患哮喘，且目前仍有哮喘”。二者诊断标准和测量时间不完全对称，须如实命名。

主分析为九个两年周期合并的横断面研究；补充分析为1999–2018十周期的曾患哮喘诊断史。不把不同受访者当成随访同一队列。主分析将 RA 作为分组因素、当前哮喘作为结局，目的为清楚表达关联，不主张 RA 先发生或导致哮喘。
...
主分析纳入2001–2002至2017–2018九周期；1999–2000仅加入曾患哮喘补充分析。三十份DEMO/MCQ/SMQ字典已核对，测量覆盖按各分支判定；实际数据质量仍须检查。
...
逐周期已核实：1999–2008 MCQ190的1代表RA；2009–2010 MCQ191的1代表RA；2011–2018 MCQ195的2代表RA。官方MCQ160A/a大小写统一后匹配，不能跨周期照搬数值编码。
...
符号先定义：w18是2001–2018主分析合并权重；w20 是1999–2018曾患哮喘补充分析权重；w4 是官方 1999–2002 四年权重；w2 是单个两年周期的官方权重。必须同属访谈或体检等同一权重类型。

- 2001–2018主分析：w18 = w2/9。依据九个等长周期各占九分之一；访谈采用WTINT2YR，体检扩展如启用采用WTMEC2YR。所有缩减周期的敏感性均按实际周期数重新构造。
- 以下两条仅用于1999–2018曾患哮喘补充分析：
...
必做：RA vs 无关节炎；相同2001–2018周期曾患替代当前哮喘；1999–2018曾患哮喘补充；当前 vs 从未哮喘；未知类型处理；共同样本；2003–2018 与2001–2018比较（需各自正确权重）；逐周期/宽时期描述及留一周期影响检查。
...
- verdict：pass（用户已整体确认计划 v0.2）；数据及科学 claims：needs evidence。
- checked：用户已确认主次问题；正式 idea 输入、17项方案内容、参考文献重叠、首尾周期编码、官方抽样要求、代码/数据存储边界。
- weak point：尚未记录老师确认；全周期与真实样本/事件/缺失未知，尚无关联结果。
- next move：v0.3范围修订已确认，恢复外置盘数据获取、连接和表型质量检查；先锁定缺失策略，再执行主模型。
