...
版本：0.1，2026-09-23。状态：**供用户/老师审阅的计划草案，未执行分析**。

## 阶段、输入、输出与验证标准

- 当前阶段：阶段二，观察性研究/分析方案编写。不是干预实验。
- 正式背景输入：[idea 文档及本次授权补充](../research_ideas/2026-09-23-nhanes-asthma-ra-idea.md)。本次直接请求授权编写计划，不伪记为老师已确认 idea；A 主问题仍属建议。
...
1. 用户/老师是否接受“两病共存”为主问题、发作为有条件次要问题？
...
- verdict：revise（待审阅锁定）；数据及科学 claims：needs evidence。
- checked：正式 idea 输入、17项方案内容、参考文献重叠、首尾周期编码、官方抽样要求、代码/数据存储边界。
- weak point：主问题未获老师确认，全周期与真实样本/事件/缺失未知，尚无关联结果。
