...
版本：0.2，2026-09-23。状态：**用户已于 2026-09-23 整体确认；进入实施阶段。计划确认不代表数据或结论已验证。**

实施勘误提示：官方逐周期审核发现1999–2000成人当前哮喘未询问，原范围不能直接实施。详见[待确认的范围修订建议](2026-09-23-scope-amendment.md)。以下保留已批准v0.2的科学内容作为审计依据，不静默改写研究年份。
...
- next move：v0.2已确认，实施已启动；T02发现成人测量覆盖限制，需确认已成文的范围修订后恢复依赖该范围的数据获取与分析。
